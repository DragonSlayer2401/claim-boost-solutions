...
const Footer = () => {
  return (
    <footer className="py-10 !px-5 flex flex-col">
      <div className="flex flex-col gap-4 md:flex-row justify-between">
        <div>
          <h4 className="font-bold text-xl mb-4 mx-auto">
        ...
        <div>
          <h4 className="font-bold text-xl mb-4 mx-auto">Quick Links</h4>
        ...
        <div className="mb-4">
          <h4 className="font-bold text-xl mb-4 mx-auto">Contact Us</h4>
